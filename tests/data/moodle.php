...
$string['allow'] = 'Allow';
$string['allowduplicateidnumber'] = 'Allow duplicate ID numbers';
$string['allowduplicateidnumber_help'] = 'Allow duplicate ID numbers to be create via a course';
...
$string['capsendemailimmediately'] = 'Enable send email immediately capability';
$string['capsendemailimmediatelydesc'] = 'Users with this capability can send emails to all users participants.';
...
$string['sendemail'] = 'Send an email';
$string['sendemailimmediately'] = 'Send email immediately';
...
* Send email - For sending email to one or more participants via your email client
...
$string['activitylogstartdate'] = 'Activity log start date'; // BASE-796.
$string['sessionexpired'] = 'Session Expired';
$string['sessionexpired_desc'] = 'Your session could not be extended as you are already logged out. If you attempt to submit any work from this page it will be lost. If you have any unsaved work on this page, copy-and-paste it into a program on your computer so you do not lose it.  You will then need to re-login to Moodle';
$string['sessionexpiryalert'] = 'Session Expiry Alert';
$string['sessionexpiryalert_desc'] = 'Your login session may be about to expire due to inactivity.  Click "Continue" now to extend your login session.';
$string['sessionextendattempt'] = 'Attempting to extend session...';
$string['sessionextended'] = 'Session Extended';
$string['sessionextended_desc'] = 'Your session has been extended successfully.  Click OK to continue working.';
$string['sessionexpiryignore'] = 'Ignore';
